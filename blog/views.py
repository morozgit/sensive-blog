...
def index(request):
    ...
    context = {
        'most_popular_posts': [
            serialize_post_optimized(post) for post in get_comments(most_popular_posts)
        ],
        'page_posts': [serialize_post_optimized(post) for post in get_comments(most_fresh_posts)],
